  ...
  return (
    <div className="bg-[#EFEEE7] px-16 pt-14 pb-9">
      <div className="flex flex-col lg:flex-row justify-around mb-5">
        <div>
          <h1 className="text-xl md:text-2xl lg:text-3xl text-black font-medium mb-1">
            Solutions
          </h1>
          <ul>
            <li className="text-lg text-black font-light">
              Smili Menu connecté
            </li>
            <li className="text-lg text-black font-light">
        ...
        <div className="my-5 md:my-8 lg:my-0">
          <h1 className="text-xl md:text-2xl lg:text-3xl text-black font-medium mb-1">
            Notre réseau
          </h1>
          <ul>
        ...
        <div className="w-96 bg-[#66666680] py-5 px-8 rounded-lg text-white">
          ...
          <form>
            <input
              className="rounded bg-[#66666680] border border-gray-100"
              type="email"
              name=""
              id=""
            />
            <input
              className="bg-[#D9D9D9] px-2 rounded ml-2"
              type="button"
              value="S’inscrire"
            />
          </form>
