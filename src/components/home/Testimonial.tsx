...
const Testimonial = () => {
  return (
    <div className="bg-[#FCF2E3] pt-14 pb-28">
      ...
      <h2 className="text-4xl text-black font-semibold">Découvrez les avis de nos cleints</h2>
      <h3 className="text-3xl text-black font-medium mt-5 border-l-4 border-[#FFCA7A] pl-4">Essayer Smili food c’est l’adopter !</h3>
      </div>
      <div className="grid grid-cols-3 gap-12 px-28 relative">
        {
